    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
      ...
      <div className="md:sticky md:top-20 space-y-4">
        <div className="relative w-full max-w-md mx-auto">
          <img src={image} alt={name} className="w-full rounded-xl shadow-md object-contain" />
          <button
            onClick={handleWishlistToggle}
            className="absolute top-3 right-3 text-2xl text-red-500 bg-white rounded-full p-2 shadow hover:scale-110 transition"
          >
